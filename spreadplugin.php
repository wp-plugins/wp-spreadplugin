    ...
    class WP_Spreadplugin {
        ...
        public function loadFoot() {
            ...
            echo "
					...
					var designerBasketId = '".(!empty($_SESSION['basketId'])?$_SESSION['basketId'][self::$shopOptions['shop_source'] . self::$shopOptions['shop_language']]:"")."';
					</script>
        ...
        public function doAjax() {
            ...
            if (isset($_POST['size']) && isset($_POST['appearance']) && isset($_POST['quantity'])) {
                ...
                $data = array(
                    'articleId' => intval($_POST['article']),'size' => intval($_POST['size']),'appearance' => intval($_POST['appearance']),'quantity' => intval($_POST['quantity']),'shopId' => self::$shopOptions['shop_id'],'type' => (!empty($_POST['type'])?$_POST['type']:"")
                );
